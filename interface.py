...
class MainWindow(QMainWindow):
    def __init__(self):
        ...
        self.start_with_windows_checkbox.setChecked(self.check_startup_status())
        self.start_with_windows_checkbox.stateChanged.connect(self.set_startup_status)
        ...
        self.tray_icon.setToolTip('Printer Control Application')
    ...
    def add_to_startup(self):
        try:
            ...
            winreg.SetValueEx(key, 'PrinterControlApp', 0, winreg.REG_SZ, sys.executable + ' ' + os.path.abspath(__file__))
            winreg.CloseKey(key)
    ...
    def check_startup_status(self):
        try:
            ...
            value, _ = winreg.QueryValueEx(key, 'PrinterControlApp')
            winreg.CloseKey(key)
            return True
